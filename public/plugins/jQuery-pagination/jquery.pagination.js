...
(function ($, window, document, undefined) {
    ...
    var old = $.fn.jqueryPagination;

    // PROTOTYPE AND CONSTRUCTOR

    var jQueryPagination = function (element, options) {
        this.$element = $(element);
        this.options = $.extend({}, $.fn.jqueryPagination.defaults, options);
    ...
    $.fn.jqueryPagination = function (option) {
        ...
        if (!data) $this.data('twbs-pagination', (data = new jQueryPagination(this, options) ));
        if (typeof option === 'string') methodReturn = data[ option ].apply(data, args);

        return ( methodReturn === undefined ) ? $this : methodReturn;
    };

    $.fn.jqueryPagination.defaults = {
        totalPages: 0,
        startPage: 1,
        visiblePages: 5,
        href: false,
    ...
    $.fn.jqueryPagination.Constructor = jQueryPagination;

    $.fn.jqueryPagination.noConflict = function () {
        $.fn.jqueryPagination = old;
        return this;
    };
